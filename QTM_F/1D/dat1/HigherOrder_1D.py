...
fric_cons = 0.12       # friction constant  

v0, dv = derivs(x)
print('Initial potential energy = {} cm-1.'.format(np.dot(v0,w) * hartree_wavenumber))
...
for k in range(Nt):
    ...
    if k == Nt-1:
        print('The total energy = {} Hartree, {} cm-1. \n'.format(Etot, Etot * hartree_wavenumber))
