...
!      enddo 
      ...
      do i=1,nb 
        x(i) = gasdev(idum1) 
        y(i) = gasdev(idum2) 
        x(i) = x(i)/dsqrt(2d0*ax0)+qx0
        y(i) = y(i)/dsqrt(2d0*ay0)+qy0
      enddo 
...
13      enddo
        ...
        call aver(nb,x,y,px,py,s,c,xav)
...
!        write(101,1000) (x(i),i=1,nb),(p(i),i=1,nb) 
        ...
        write(105,1000) t,(px(i),i=1,10)
        write(106,1000) t,(x(i),i=1,10)
...
!     average x 
!     ---------------------------------------------
      subroutine aver(nb,x,y,px,py,s,c,xav)
      use cdat 
