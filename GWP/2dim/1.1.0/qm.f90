...
!     print out final wavefunction         
      ...
      do i=1,npx 
        ...
        do j=1,npy 
          yi = ymin + dy*(j-1)                   
          call psi(xi,yi,nb,c,x,y,s,z0) !    if(abs(z0).gt.1d-3) 
...
!          call pot(xc,yc,v0,v11,v22)
         ...
         d1 = vc*xc**2/8d0 + vc*yc**2/8d0 - vb*yc**2/4d0 + vb**2/4d0/va -vc* xc*yc/4d0 & 
               + va*yc**4/16d0 + & 
             (3d0/4d0)*va*yc**2/ay + vc/ax/4d0 + vc/4d0/ay -vb/2d0/ay+ 3d0*va/(4d0*ay**2)
!     -----------------------
