...
!----------------------------------------------------------------------
      ...
      complex*16 :: z0,zn,z,psi,z1,dpsi,cor,corr  
...
!------check normalization--------------
      ...
      do i=1,np
        ...
        if(abs(z0).gt.1d-3) write(104,1000) xi,abs(z0)**2,r 
      enddo
      write(*,1013)  prob
...
!      print *,'q,s',q(1),q(2),q(3),s(1),s(2),s(3)
...
!      print *,'mat =', mat(1,2),mat(3,4)
      ...
      do j=1,nb
        do k=1,nb
          ...
          z0 = exp(-al*dq**2/4d0)
!          print *,'z=',z,am 
!          print *,'z0 =',z0,al,v(1),p(1),dv(k),ddv(k)  
