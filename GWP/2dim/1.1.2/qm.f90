...
!----------------------------------------------------------------------
      ...
      complex*16, allocatable :: c(:),c0(:),dc(:),c1(:),cold(:),cnew(:)
...
!      common/grid/xmin,xmax,dx,np
      ...
      open(120,file='xy1.dat')
      open(121,file='xy2.dat')
      open(122,file='xy3.dat')
      open(123,file='xy4.dat') 
...
!       print out snapshots of GWP centers 
        if(kt == kmax/4) then
          do i=1,nb  
          write(120,1000) x(i),y(i)
          enddo 
        elseif(kt == kmax/2) then 
          do i=1,nb 
          write(121,1000) x(i),y(i)
          enddo 
        elseif(kt == kmax*3/4) then 
         do i=1,nb 
          write(122,1000) x(i),y(i)
         enddo 
        elseif(kt == kmax) then 
          do i=1,nb 
          write(123,1000) x(i),y(i)
          enddo 
        endif 
