...
pl.plot(data[:,0],data[:,1],'b--',linewidth=2,label='L = 8, without diff Domain')
pl.plot(data[:,0],data[:,2],'b--',linewidth=2)

dat = np.genfromtxt(fname='../spo_2d/1.0.2/den.dat') 
...
dat2 = np.genfromtxt(fname='../1.0.5/dom8/den.dat') 
pl.plot(dat2[:,0],dat2[:,1],'g',linewidth=2,label='L = 8, with diff domain ')
